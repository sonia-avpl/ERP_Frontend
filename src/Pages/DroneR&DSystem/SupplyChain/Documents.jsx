 ...
 <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Expiry Requests</p>
              ...
              <div className="bg-white rounded-xl shadow-sm">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="border-2 border-dashed border-red-300 rounded-lg p-6 text-center hover:border-red-500 hover:bg-red-50 transition-colors cursor-pointer">
                    ...
                    <h4 className="font-semibold text-gray-800 mb-2">Damages Received Note (DRN)</h4>
                    <p className="text-sm text-gray-600 mb-4">Report damaged goods and returns</p>
                  ...
                  <div className="border-2 border-dashed border-yellow-300 rounded-lg p-6 text-center hover:border-yellow-500 hover:bg-yellow-50 transition-colors cursor-pointer">
                    ...
                    <h4 className="font-semibold text-gray-800 mb-2">Expiry Requisition Note (ERN)</h4>
                    <p className="text-sm text-gray-600 mb-4">Manage expired inventory removal</p>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b">
                          <th className="text-left py-3 px-4 font-medium text-gray-600">Document ID</th>
                          <th className="text-left py-3 px-4 font-medium text-gray-600">Type</th>
                          <th className="text-left py-3 px-4 font-medium text-gray-600">Supplier/Item</th>
                          <th className="text-left py-3 px-4 font-medium text-gray-600">Quantity/Value</th>
                      ...
                      <tbody>
                        ...
                        <tr className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">GRN</span>
                          </td>
                        ...
                        <tr className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-xs">Processed</span>
                          </td>
                        ...
                        <tr className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <span className="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs font-medium">DRN</span>
                          </td>
                        ...
                        <tr className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-medium">ERN</span>
                          </td>
                          <td className="py-3 px-4">Expired Antibiotics</td>
                          <td className="py-3 px-4">150 units</td>
                          <td className="py-3 px-4">
                            <span className="px-3 py-1 bg-red-100 text-red-800 rounded-full text-xs">Urgent</span>
                          </td>
                          <td className="py-3 px-4">Jun 8, 2025</td>
                          <td className="py-3 px-4">
                            <div className="flex items-center space-x-2">
